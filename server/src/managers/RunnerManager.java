...
//
//        }
//        String[] requestCommandArgs = Arrays.copyOfRange(requestParts, 1, requestParts.length);
...
//            if (command.getArgsCount() != requestCommandArgs.length) {
...
//                return;
//            }
//            command.execute(requestCommandArgs);
